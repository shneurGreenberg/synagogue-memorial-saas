const translations = {
  en: {
    settings: 'Settings',
    title: 'Title',
    board_title_main: 'Main board title',
    board_title_ru: 'Title in Russian',
    board_title_en: 'Title in English',
    board_title_he: 'Title in Hebrew',
    board_title_auto_hint: 'Leave a language blank to auto-translate from the main title.',
  ...
  ru: {
    settings: 'Настройки',
    title: 'Название',
    board_title_main: 'Основной заголовок доски',
    board_title_ru: 'Заголовок на русском',
    board_title_en: 'Заголовок на английском',
    board_title_he: 'Заголовок на иврите',
    board_title_auto_hint: 'Оставьте поле пустым — заголовок переведётся автоматически с основного.',
  ...
  he: {
    settings: 'הגדרות',
    title: 'כותרת',
    board_title_main: 'כותרת ראשית של הלוח',
    board_title_ru: 'כותרת ברוסית',
    board_title_en: 'כותרת באנגלית',
    board_title_he: 'כותרת בעברית',
    board_title_auto_hint: 'השאירו ריק לתרגום אוטומטי מהכותרת הראשית.',
