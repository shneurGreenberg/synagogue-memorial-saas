const STRINGS = {
  en: {
    ...
    disabled_message: 'Public name submission is not available at this time. The synagogue administrator can enable it in the admin settings under “Public name submission”.',
    disabled_error: 'Public name submission is currently disabled.',
  ...
  ru: {
    ...
    disabled_message: 'Публичная подача имён сейчас недоступна. Администратор может включить её в настройках в разделе «Публичная подача имён».',
    disabled_error: 'Публичная подача имён сейчас отключена.',
  ...
  he: {
    ...
    disabled_message: 'הוספת שמות ציבורית אינה פעילה כעת. מנהל בית הכנסת יכול להפעיל אותה בהגדרות, תחת «הוספת שם ציבורית».',
    disabled_error: 'הוספת שמות ציבורית כבויה כרגע.',
