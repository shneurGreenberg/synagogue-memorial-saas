const STRINGS = {
  en: {
    ...
    contact_required_error: 'Please provide a contact phone number or email.',
  ...
  ru: {
    ...
    contact_required_error: 'Пожалуйста, укажите телефон или email контакта.',
    contact_platform_whatsapp: 'WhatsApp',
    contact_platform_telegram: 'Telegram',
    contact_platform_max: 'MAX',
    contact_platform_sms: 'SMS',
  ...
  he: {
    ...
    contact_section_title: 'איש קשר משפחתי',
    ...
    contact_required_error: 'נא למלא מספר טלפון או כתובת אימייל של איש הקשר.',
...
function getContactPlatformOptions(lang) {
  ...
  return CONTACT_PLATFORM_KEYS.map((value) => ({
    value,
