...
const HOLIDAYS = {
  ...
  'Tzom Tammuz': { ru: 'Пост 17 Таммуза', en: 'Fast of 17 Tammuz', he: 'צום י״ז בתמוז' },
  "Asara B'Tevet": { ru: 'Пост 10 Тевета', en: "Fast of 10 Tevet", he: 'צום עשרה בטבת' },
  'Ta\'anit Esther': { ru: 'Пост Эстер', en: "Fast of Esther", he: 'תענית אסתר' },
  'Tzom Gedaliah': { ru: 'Пост Гедалии', en: 'Fast of Gedaliah', he: 'צום גדליה' },
  "Erev Tish’a B’Av": { ru: 'Канун Тиша бе-Ав', en: "Erev Tish’a B’Av", he: 'ערב תשעה באב' },
  "Tish’a B’Av": { ru: 'Тиша бе-Ав', en: "Tish’a B’Av", he: 'תשעה באב' },
  "Tu B’Av": { ru: 'Ту бе-Ав', en: "Tu B’Av", he: 'ט״ו באב' },
