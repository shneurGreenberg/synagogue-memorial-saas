...
const PAGE_PERMISSION_KEYS = ['people', 'peopleImport', 'contactDirectory', 'events'];
...
const PAGE_PERMISSION_META = [
  ...
  { key: 'contactDirectory', labelKey: 'perm_contact_directory' },
...
function normalizePermissions(raw) {
  ...
  const permissions = {
    ...
    contactDirectory: Object.prototype.hasOwnProperty.call(source, 'contactDirectory')
      ? !!source.contactDirectory
      : source.people !== false,
...
function getDefaultLandingPath(slug, permissions) {
  const order = [
    ...
    { key: 'contactDirectory', path: 'contact-directory' },
...
function parsePermissionsFromBody(body) {
  const permissions = {
    ...
    contactDirectory: body.permission_contactDirectory === '1' || body.permission_contactDirectory === 'true' || body.permission_contactDirectory === true,
