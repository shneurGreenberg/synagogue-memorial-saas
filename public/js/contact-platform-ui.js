(function () {
  var ICONS = {
    ...
    max: '<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M4 4h16v16H4V4zm3 3v10h2.2l2.3-3.1 2.3 3.1H16l-3.2-4.3L16 7H13.8l-2.3 3.1L9.2 7H7z"/></svg>',
