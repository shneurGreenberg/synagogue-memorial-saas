...
const resources = {
  en: {
    translation: {
      ...
      hayom_yom_unavailable: 'No free Hayom Yom API — open Chabad.org or the Russian book edition.',
      hayom_yom_hebrew: 'Hebrew (Chabad.org)',
      hayom_yom_english: 'English (Chabad.org)',
      hayom_yom_russian_book: 'Russian book (Гайом Йом)',
  ...
  ru: {
    translation: {
      ...
      hayom_yom_unavailable: 'Бесплатного API нет — откройте Chabad.org или русское издание книги.',
      hayom_yom_hebrew: 'Иврит (Chabad.org)',
      hayom_yom_english: 'Английский (Chabad.org)',
      hayom_yom_russian_book: 'Книга на русском (Гайом Йом)',
  ...
  he: {
    translation: {
      ...
      hayom_yom_unavailable: 'אין API חינמי — פתחו את Chabad.org או מהדורה רוסית בספר.',
      hayom_yom_hebrew: 'עברית (Chabad.org)',
      hayom_yom_english: 'אנגלית (Chabad.org)',
      hayom_yom_russian_book: 'ספר ברוסית (Гайом Йом)',
