...
import { izkorTransliteration, kelMaleRachamimTransliteration } from './prayer-transliterations';
...
const resources = {
  en: {
    translation: {
      ...
      kel_male_rachamim_text: kelMaleRachamimTransliteration.en,
      izkor: 'Memorial Prayer',
      izkor_text: izkorTransliteration.en,
  ...
  ru: {
    translation: {
      ...
      kel_male_rachamim_text: kelMaleRachamimTransliteration.ru,
      izkor: 'Поминальная молитва',
      izkor_text: izkorTransliteration.ru,
