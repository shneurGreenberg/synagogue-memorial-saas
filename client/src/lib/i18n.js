...
const resources = {
  ...
  ru: {
    translation: {
      ...
      memorial_submission_scan: 'Отсканируйте QR-код, чтобы отправить имя',
      memorial_submission_qr_alt: 'QR-код для добавления имени',
      donation_qr_title: 'Поддержать общину',
      donation_qr_scan: 'Отсканируйте для пожертвования',
