export const STRINGS = {
  ru: {
    ...
    server_url_hint: 'Можно вставить полный адрес либо только домен, например https://example.com или https://example.com/s/novosibirsk',
  ...
  en: {
    ...
    server_url_hint: 'You can paste the full board URL or just the domain, e.g. https://example.com or https://example.com/s/novosibirsk',
  ...
  he: {
    ...
    server_url_hint: 'אפשר להדביק את כתובת הלוח המלאה או רק את הדומיין, למשל https://example.com או https://example.com/s/novosibirsk',
